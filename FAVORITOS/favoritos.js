...
function crearDiv(start, fin) {
  for (let i = start; i < fin; i++) {
    ...
    expandir.src = ".PROYECTO2/assets/icon-max-normal.svg"
    descargar.src = ".PROYECTO2/assets/icon-download.svg"
    eliminar.src = ".PROYECTO2/assets/icon-trash-normal.svg"
    cambiarSrc(eliminar, ".PROYECTO2/assets/icon-trash-hover.svg", ".PROYECTO2/assets/icon-trash-normal.svg")
    ...
    cambiarSrc(expandir, ".PROYECTO2/assets/icon-max-hover.svg", ".PROYECTO2/assets/icon-max-normal.svg")
    expandir.addEventListener("click", () => {
      tituloTrending.setAttribute("hidden", "")
      expansion.removeAttribute("hidden")
      imagenExpandida.src = elementurl
    })
    cambiarSrc(descargar, "", ".PROYECTO2/assets/icon-download.svg")
    descargar.addEventListener("mouseover", () => {
      descargar.src = ".PROYECTO2/assets/icon-download-hover.svg"
